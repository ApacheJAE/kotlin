...
class FunctionReader(
    ...
    private val functionCache = object : SLRUCache<CallableDescriptor, NamedFunction>(50, 50) {
        override fun createValue(descriptor: CallableDescriptor): NamedFunction =
    ...
    operator fun get(descriptor: CallableDescriptor): NamedFunction = functionCache.get(descriptor)

    private fun readFunction(descriptor: CallableDescriptor): NamedFunction? {
    ...
    private fun readFunctionFromSource(descriptor: CallableDescriptor, info: ModuleInfo): NamedFunction? {
